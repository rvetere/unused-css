# unused-css loader for webpack

## installation

`npm install unused-css --save-dev`
...
``` javascript
var css = require("unused-css!./file.js");
// => reports unused css definitions found in the given javascript file (could be any component code of react/angular/anything in ES5/ES6)
```
